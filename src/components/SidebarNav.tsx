  ...
  return (
    <aside className="w-[300px] shrink-0 bg-[var(--bg-2)] border-r border-[var(--border)] flex flex-col">
      ...
      <div className="px-3 pb-3 flex items-center gap-2">
        ...
        <a
          href={process.env.NEXT_PUBLIC_BROWSER_UI_URL ?? "http://localhost:4000"}
          target="_blank"
          rel="noreferrer"
          title="Open the browser manager (profiles & live sessions)"
          aria-label="Open browser manager"
          className="shrink-0 rounded-xl border border-[var(--border-strong)] bg-[var(--panel)] text-[var(--muted)] hover:text-[var(--text)] hover:bg-[var(--panel-2)] transition w-9 h-9 flex items-center justify-center"
        >
