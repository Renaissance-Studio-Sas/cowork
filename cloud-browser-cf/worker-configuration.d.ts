/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02051b9461ab3b789385f81db9d964bf)
// Runtime types generated with workerd@1.20260421.1 2025-05-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BrowserSession" | "BrowserMcp";
	}
	interface Env {
		PROFILES: R2Bucket;
		API_TOKEN: string;
		BROWSER_SESSION: DurableObjectNamespace<import("./src/index").BrowserSession>;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").BrowserMcp>;
	}
}
